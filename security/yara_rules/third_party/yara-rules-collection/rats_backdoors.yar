...
rule Generic_RAT_Indicators
{
    ...
    condition:
        // Require indicators from at least 2 different categories
        // to reduce false positives on legitimate Windows apps
        (2 of ($kl*) and 2 of ($sc*) and 1 of ($net*)) or
        (1 of ($cam*) and 2 of ($kl*) and 1 of ($net*)) or
        (2 of ($sc*) and 1 of ($cam*) and 1 of ($net*) and 1 of ($kl*))
}
